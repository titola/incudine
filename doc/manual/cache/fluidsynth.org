...
#+attr_texinfo: :options fluidsynth:settings-getstr settings name str
#+begin_defun
#+end_defun
...
#+attr_texinfo: :options fluidsynth:get-channel-info synth chan info
#+begin_defun
#+end_defun
...
#+attr_texinfo: :options fluidsynth:get-chorus-speed-hz synth
#+begin_defun
#+end_defun

#+attr_texinfo: :options fluidsynth:get-chorus-depth-ms synth
#+begin_defun
#+end_defun
...
#+attr_texinfo: :options fluidsynth:set-gen2 synth chan param value absolute normalized
#+begin_defun
#+end_defun
...
**** Tuning
#+attr_texinfo: :options fluidsynth:create-key-tuning synth bank prog name pitch
#+begin_defun
#+end_defun
...
#+attr_texinfo: :options fluidsynth:create-octave-tuning synth bank prog name pitch
#+begin_defun
#+end_defun
...
#+attr_texinfo: :options fluidsynth:select-tuning synth chan bank prog
#+begin_defun
#+end_defun
...
#+attr_texinfo: :options fluidsynth:reset-tuning synth chan
#+begin_defun
#+end_defun
...
#+attr_texinfo: :options fluidsynth:set-midi-router synth router
#+begin_defun
#+end_defun
